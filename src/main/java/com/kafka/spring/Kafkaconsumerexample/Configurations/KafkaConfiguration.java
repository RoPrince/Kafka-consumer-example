package com.kafka.spring.Kafkaconsumerexample.Configurations;

import com.kafka.spring.Kafkaconsumerexample.model.Person;
...
public class KafkaConfiguration {
    ...
    public ConsumerFactory<String, Person> personConsumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<String, Person>(config, new StringDeserializer(), new JsonDeserializer<>(Person.class));
